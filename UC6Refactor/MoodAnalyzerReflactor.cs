...
namespace UC6Refactor
{
    public class MoodAnalyzerReflactor
    {
        ...
        {
            Type type = typeof(MoodAnalyzerReflactor);
        ...
        public static string InvokeAnalyseMood(string message, string MethodName)
        {
            try
            {
                ...
                object mmodanalyseobject = MoodAnalyzerReflactor.CreateMoodParameterConstructor("MoodAnalyzerApp.MoodAnalyse", "MoodAnlalyse", message);
